...
const GUIAS: Guia[] = [
  ...
  },
  {
    id: 'citas',
    modulo: 'Citas',
    titulo: 'Citas con Clientes',
    descripcion: 'Programar entrevistas previas a la aprobación de un préstamo o financiamiento.',
    icon: CalendarCheck,
    color: 'bg-violet-500/10 text-violet-600 border-violet-500/20',
    ruta: '/citas',
    nivel: 'Básico',
    pasos: [
      { titulo: 'Programar cita desde la Solicitud', detalle: 'Si el oficial de cuenta considera que el cliente necesita entrevista con el administrador antes de aprobar, abre la solicitud y crea la cita asociada.' },
      { titulo: 'Definir fecha, hora y motivo', detalle: 'Selecciona día y hora dentro del horario laboral configurado en Ajustes. Indica el motivo (evaluación, validación de ingresos, garantía, etc.).' },
      { titulo: 'Revisar la cita programada', detalle: 'En el menú "Citas" aparecen todas las citas con su estado (Programada, Confirmada, Realizada, Cancelada). El sidebar muestra un badge con el total pendiente.' },
      { titulo: 'Indicador en Solicitudes', detalle: 'Las solicitudes con cita pendiente muestran un ícono de reloj junto al número, para que el administrador sepa que debe esperar la entrevista antes de decidir.' },
      { titulo: 'Decidir tras la entrevista', detalle: 'Al concluir la cita, marca el resultado y regresa a la solicitud para Aprobar o Rechazar el préstamo o financiamiento propuesto.' },
    ],
    tips: ['El badge de citas pendientes en el sidebar te ayuda a no perder ninguna entrevista del día.', 'Las citas quedan vinculadas a la solicitud, así hay trazabilidad de la decisión.'],
  },
  {
    id: 'horarios',
    modulo: 'Ajustes › Horarios',
    titulo: 'Horario Laboral de la Empresa',
    descripcion: 'Definir los días y horas de atención de Domingo a Sábado.',
    icon: Clock,
    color: 'bg-sky-500/10 text-sky-600 border-sky-500/20',
    ruta: '/ajustes',
    nivel: 'Básico',
    pasos: [
      { titulo: 'Abrir Ajustes › Empresa', detalle: 'En la pestaña "Empresa" encontrarás el bloque "Horario Laboral" con los 7 días de la semana.' },
      { titulo: 'Activar días laborables', detalle: 'Habilita los días en que la empresa atiende y deja desactivados los días de cierre.' },
      { titulo: 'Definir hora de apertura y cierre', detalle: 'Para cada día activo configura hora de inicio y fin. Estos horarios se usan al programar citas con clientes.' },
      { titulo: 'Guardar cambios', detalle: 'Los horarios se aplican inmediatamente al módulo de Citas y a las validaciones de agendamiento.' },
    ],
  },
  {
    id: 'redes-sociales',
    modulo: 'Ajustes › Redes',
    titulo: 'Redes Sociales de la Empresa',
    descripcion: 'Registrar Facebook, Instagram, WhatsApp, sitio web y otras redes.',
    icon: Share2,
    color: 'bg-pink-500/10 text-pink-600 border-pink-500/20',
    ruta: '/ajustes',
    nivel: 'Básico',
    pasos: [
      { titulo: 'Ir a Información de la Empresa', detalle: 'Ajustes › pestaña Empresa › sección Redes Sociales.' },
      { titulo: 'Capturar enlaces o usuarios', detalle: 'Agrega URL o nombre de usuario de Facebook, Instagram, WhatsApp, sitio web, etc.' },
      { titulo: 'Uso en documentos', detalle: 'Las redes aparecen en la Tarjeta de Presentación y pueden incluirse en pies de PDF.' },
    ],
  },
  {
    id: 'tarjeta',
    modulo: 'Ajustes › Tarjeta',
    titulo: 'Tarjeta de Presentación',
    descripcion: 'Generar y descargar la tarjeta corporativa en PNG o JPG.',
    icon: IdCard,
    color: 'bg-fuchsia-500/10 text-fuchsia-600 border-fuchsia-500/20',
    ruta: '/ajustes',
    nivel: 'Básico',
    pasos: [
      { titulo: 'Completar Información de la Empresa', detalle: 'Nombre, RNC, dirección, teléfono, correo, logo y redes sociales — todo se refleja en la tarjeta.' },
      { titulo: 'Elegir tema visual', detalle: 'Selecciona entre Azul, Verde, Oscuro o Claro. La vista previa se actualiza al instante.' },
      { titulo: 'Descargar PNG o JPG', detalle: 'La tarjeta se exporta en 1050×600 px a 3x de resolución, lista para imprimir o compartir.' },
    ],
    tips: ['Si actualizas logo o redes, regenera la tarjeta para reflejar los cambios.'],
  },
  {
    id: 'notificaciones',
    modulo: 'Notificaciones',
    titulo: 'Panel de Notificaciones',
    descripcion: 'Alertas en el encabezado: citas del día, mora y eventos importantes.',
    icon: Bell,
    color: 'bg-yellow-500/10 text-yellow-600 border-yellow-500/20',
    ruta: '/',
    nivel: 'Básico',
    pasos: [
      { titulo: 'Abrir el panel', detalle: 'Haz clic en el ícono de campana en el encabezado superior de cualquier pantalla.' },
      { titulo: 'Revisar citas pendientes', detalle: 'Muestra citas programadas para hoy y próximas, con acceso directo al módulo Citas.' },
      { titulo: 'Atender alertas de mora y riesgo', detalle: 'Notifica clientes en mora avanzada o con score crediticio bajo para acción inmediata.' },
    ],
  },
];
